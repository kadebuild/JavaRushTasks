...
public class Solution {
    ...
    public static void reset() {
        ...
        try
        {
            String bufFly = reader.readLine();
            if (bufFly.equals("helicopter"))
                result = new Helicopter();
            else if (bufFly.equals("plane"))
            {
                int numOfPassenger = Integer.parseInt(reader.readLine());
                result = new Plane(numOfPassenger);
            }
            reader.close();
        }
        catch (IOException e) {}
